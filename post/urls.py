...
urlpatterns = [
                       ...
                       url(r'^course/interested/(?P<course_id>[0-9]+)/$', views.interested_course, name='interested_course'), 
                       url(r'^course/uninterested/(?P<course_id>[0-9]+)/$', views.uninterested_course, name='uninterested_course'), 

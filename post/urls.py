...
urlpatterns = [
                       ...
                       # update post
                       url(r'^update/(?P<kind>[a,c]{1})/(?P<id>[0-9]+)/$', views.update, name='update'),
                       
                       # remove post
                       url(r'^remove/(?P<kind>[a,c]{1})/(?P<id>[0-9]+)/$', views.remove, name='remove'),
                       
                       # tag
                       url(r'^addtag/(?P<kind>[a,c]{1})/(?P<id>[0-9]+)/$', views.add_tag, name='addtag'),
